...
import com.code.cpo.ui.HttpItem;
import com.code.cpo.ui.TinyCoach;
...
//        fpsConfig = null;
    ...
    public void updateHttp(@NotNull HttpTime httpTime) {
        tinyCoach.updateHttp(httpTime);
    }
}

...
public class DensityUtil {
    private static float sCahcedDensity = -1;
    private static float sScaleDenisty = -1;

    public static void cacheDensity(Context context) {
        sCahcedDensity = context.getResources().getDisplayMetrics().density;
        sScaleDenisty = context.getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static int dip2px(Context c, float dpValue) {
        ...
        final float scale = (sCahcedDensity > 0 ? sCahcedDensity : c.getResources().getDisplayMetrics().density);
    ...
    public static int px2sp(Context c, float pxValue) {
        float fontScale = (sScaleDenisty > 0 ? sScaleDenisty : c.getResources().getDisplayMetrics().scaledDensity);
